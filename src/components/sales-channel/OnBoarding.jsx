...
const OnBoarding = () => {
    ...
    const fetchProjectType = async (proj_type) => {
      ...
      try {
        ...
        const response = await fetch(
          ...
          }/project/getAvailableFilteredProjectNames?project_type=${proj_type}`,
          {
            headers: {
  ...
  const fetchTowerNumber = async (selectedProjectName) => {
    ...
    try {
      ...
      const response = await fetch(
        `${
          import.meta.env.VITE_BASE_URL
        }/project/getFilteredTowerNumbers?project_name=${selectedProjectName}`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
  ...
  const fetchFlatNumber = async (selectedProjectName, selectedTowerNumber) => {
    ...
    try {
      ...
      const response = await fetch(
        `${
          import.meta.env.VITE_BASE_URL
        }/project/getFilteredFlatNumbers?project_name=${selectedProjectName}&tower_number=${selectedTowerNumber}`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
  ...
  const fetchVillaNumber = async (selectedProjectName) => {
    try {
      ...
      const response = await fetch(
        `${
          import.meta.env.VITE_BASE_URL
        }/project/getFilteredVillaNumbers?project_name=${selectedProjectName}`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
  ...
  const fetchPlotNumber = async (selectedProjectName) => {
    try {
      ...
      const response = await fetch(
        `${
          import.meta.env.VITE_BASE_URL
        }/project/getFilteredPlotNumbers?project_name=${selectedProjectName}`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
  ...
  const fetchFarmPlotNumber = async (selectedProjectName) => {
    try {
      ...
      const response = await fetch(
        `${
          import.meta.env.VITE_BASE_URL
        }/project/getFilteredPlotNumbersOfFLs?project_name=${selectedProjectName}`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
      ...
      if (!response.ok) {
        throw new Error(
          "Network error. Failed to fetch farm land plot numbers."
        );
      }
      const result = await response.json();
  ...
  const fetchSquareYard = async (
    selectedProjectName,
    selectedFarmPlotNumber
  ) => {
    try {
      const accessToken = localStorage.getItem("token");
      const response = await fetch(
        `${
          import.meta.env.VITE_BASE_URL
        }/project/getSqYards?project_name=${selectedProjectName}&plot_number=${selectedFarmPlotNumber}`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      parseFloat(onBoardFormData.no_of_days_blocked) < 0
    ) {
    ...
    if (
      ...
      parseFloat(onBoardFormData.ta_amount) < 0
    ) {
    ...
    try {
      const accessToken = localStorage.getItem("token");
      const response = await fetch(
        `${import.meta.env.VITE_BASE_URL}/receipt/createReceipt`,
        {
          method: "POST",
          headers: {
            ...
            <form onSubmit={handleSubmit}>
              <div className="board-field">
                ...
                <input
                  ...
                  name=""
                  id="sales_person_id"
                  value={onBoardFormData.sales_person_id}
              ...
              <div className="board-field">
                ...
                <input
                  ...
                  value={onBoardFormData.sales_person_name}
                  onChange={handleChange}
              ...
              <div className="board-field">
                ...
                <input
                  ...
                  name=""
                  id="client_name"
                  value={onBoardFormData.client_name}
                  onChange={handleChange}
              ...
              <div className="board-field">
                ...
                <input
                  ...
                  name=""
                  id="client_phn_no"
                  value={onBoardFormData.client_phn_no}
                  onChange={handleChange}
              ...
              <div className="board-field">
                ...
                <input
                  ...
                  name=""
                  id="client_adhar_no"
                  value={onBoardFormData.client_adhar_no}
                  onChange={handleChange}
              ...
              {aadhaarError && (
                <p style={{ color: "red", fontSize: "14px" }}>{aadhaarError}</p>
              )}
              <div className="board-field">
                <label htmlFor="project_type">Project Type *</label>
                <select
                  id="project_type"
                  value={onBoardData.project_type}
                ...
                >
                  ...
                  <option value="APARTMENT" style={{ fontSize: "14px" }}>
                    Apartments
                  </option>
                  <option value="VILLA" style={{ fontSize: "14px" }}>
                    Villas
                  </option>
                  <option value="PLOT" style={{ fontSize: "14px" }}>
                    Plots
                  </option>
                  <option value="FARM_LAND" style={{ fontSize: "14px" }}>
                    Farm Lands
                  </option>
                </select>
              </div>
                ...
                <>
                  ...
                  <div className="board-field">
                    ...
                    <input
                      ...
                      name=""
                      id="priceOfProperty"
                      value={onBoardFormData.priceOfProperty}
                      onChange={handleChange}
                      placeholder="Property Price (Remark)"
                    />
                  </div>
                  <div className="board-field">
                    ...
                    <input
                      ...
                      name=""
                      id="discount"
                      value={onBoardFormData.discount}
                      onChange={handleChange}
                      placeholder="Enter Discount % (Remark)"
                    />
                  </div>
                  {roleType === "SALES PERSON" && (
                    <div className="board-field">
                      <label htmlFor="type_of_commission">
                        Type of Commission *
                      </label>
                      <select
                        id="type_of_commission"
                        value={onBoardFormData.type_of_commission}
                        onChange={handleChange}
                        required
                      >
                  ...
                  <div className="board-field">
                    ...
                    <div className="status">
                      <input
                        ...
                        checked={onBoardData.status === "Token"}
                      />
                      ...
                      <input
                        ...
                        value="Advance"
                        onChange={handleStatusChange}
                        checked={onBoardData.status === "Advance"}
                      />
                      ...
                      <input
                        ...
                        value="Block"
                        onChange={handleStatusChange}
                        checked={onBoardData.status === "Block"}
                      />
                  ...
                  {onBoardData.status === "Block" && (
                    <>
                      <div className="board-field">
                        <label htmlFor="no_of_days_blocked">
                          Enter the days *
                        </label>
                        <input
                          type="number"
                          name=""
                          id="no_of_days_blocked"
                          value={onBoardFormData.no_of_days_blocked}
                          onChange={handleChange}
                      ...
                      <div className="board-field">
                        ...
                        <input
                          ...
                          name=""
                          id="remark"
                          value={onBoardFormData.remark}
                          onChange={handleChange}
                        />
                      </div>
                    </>
                  )}
                  {(onBoardData.status === "Token" ||
                    onBoardData.status === "Advance") && (
                    <>
                      <div className="board-field">
                        <label htmlFor="ta_mode_of_payment">
                          Mode of Payment *
                        </label>
                        <select
                          id="ta_mode_of_payment"
                          value={onBoardFormData.ta_mode_of_payment}
                          onChange={handleChange}
                          required
                        >
                      ...
                      <div className="board-field">
                        ...
                        <input
                          ...
                          name=""
                          id="ta_amount"
                          value={onBoardFormData.ta_amount}
                          onChange={handleChange}
              ...
              {onBoardData.project_type === "FARM_LAND" && (
                <>
                  ...
                  <div className="board-field">
                    ...
                    <select
                      id="sq_yards"
                      value={squareYardData}
                      onChange={handleSqYardChange}
                      required
                    >
                      <option value="" style={{ fontSize: "14px" }}>
                        Select Square Yards
