                ...
                <div className="board-form">
                    <form onSubmit={handleSubmit}>
                        <div className="board-field">
                            ...
                            <input type="text" name="" id="sales_person_id" value={onBoardFormData.sales_person_id} onChange={handleChange} placeholder="Enter Sales Person Id" />
                        </div>
                        <div className="board-field">
                            <label htmlFor="sales_person_name">Sales Person Name *</label>
                            <input type="text" name="" id="sales_person_name" value={onBoardFormData.sales_person_name} onChange={handleChange} placeholder="Enter Sales Person Name" />
                        </div>
                        <div className="board-field">
                            ...
                            <>
                                ...
                                <div className="board-field">
                                    ...
                                    <div className="status">
                                        <input type="radio" id="status" value="Token" onChange={handleStatusChange} checked={onBoardData.status === 'Token'} />
                                        <label htmlFor="token">Token</label>
                                        <input type="radio" id="status" value="Advance" onChange={handleStatusChange} checked={onBoardData.status === 'Advance'}/>
                                        <label htmlFor="advance">Advance</label>
                                        <input type="radio" id="status" value="Blocked" onChange={handleStatusChange} checked={onBoardData.status === 'Blocked'} />
