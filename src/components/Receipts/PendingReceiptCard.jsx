...
const PendingReceiptCard = ({ projectID, receiptsData, onClose }) => {
  const receiptData = receiptsData.find(
    (receipt) => receipt.projectID === projectID
  );
  const discountedPrice =
    receiptData.priceOfProperty * (1 - receiptData.discount / 100);
          ...
          <>
            ...
            <div className="rec-data-field">
              ...
              <input
                type="text"
                id="dateOfOnboard"
                defaultValue={receiptData.dateOfOnboard}
                readOnly
              />
            </div>
            <div className="rec-data-field">
            ...
            <div className="rec-data-field">
              ...
              <input
                type="text"
                id="towerNumber"
                defaultValue={receiptData.towerNumber}
                readOnly
              />
            </div>
            <div className="rec-data-field">
              ...
              <input
                type="text"
                id="flatNumber"
                defaultValue={receiptData.flatNumber}
                readOnly
              />
            </div>
            <div className="rec-data-field">
              ...
              <>
                ...
                <div className="rec-data-field">
                  ...
                  <input
                    type="text"
                    id="remark"
                    defaultValue={receiptData.remark}
                    readOnly
                  />
                </div>
              </>
            ...
            <div className="rec-data-field">
              ...
              <input
                type="text"
                id="typeOfCommission"
                defaultValue={receiptData.typeOfCommission}
              />
            </div>
            <div className="rec-data-field">
              ...
              <input
                type="text"
                id="totalCommission"
                defaultValue={receiptData.totalCommission}
              />
            </div>
            <div className="rec-data-field">
